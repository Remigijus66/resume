...
// import parse from '@type/autosuggest-highlight/umd/parse';
...
// const GOOGLE_MAPS_API_KEY = 'zaSyDAAPUFwT8luAVssdp6TOeIy_BjIaRw3NA';
...
export default function GoogleMaps({currentLocacion}) {
  ...
  React.useEffect(() => {
    // console.log('currentLocation', currentLocacion)
    let active = true;
